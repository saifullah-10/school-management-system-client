...
const AddTeacherForm = () => {
    ...
    return (
        <div className="overflow-x-auto p-8 px-6 bg-[#F0F1F3]">
            ...
            <form className="bg-white shadow-md rounded p-6 text-gray-500" onSubmit={handleSubmit}>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-4 text-sm">
                    ...
                    <div>
                        ...
                        <select
                            ...
                            required
                        >
                            <option className='' value="">Please Select Section</option>
                            <option value="A">A</option>
                            <option value="B">B</option>
                        </select>
                    </div>
                    ...
                    <div>
                        <label className=" text-gray-500">Upload Student Photo <span className='text-gray-400'>(150px X 150px)</span></label>
                        <input
                            type="file"
                            name="file"
