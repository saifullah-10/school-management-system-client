            ...
            <div className="relative z-10 max-w-lg w-full py-10 px-5 sm:p-10  rounded-[10px] shadow-lg">
                ...
                <div className="relative z-10">
                    <div className="text-center mb-6">
                        ...
                        <Link href={"/"} className="font-bold flex items-center justify-center py-1 hover:bg-white rounded-[10px] border-2 border-transparent  hover:border-[#704FE6]">
                    ...
                    <form className="mt-8" onSubmit={handleSubmit(onSubmit)}>
                        <div className="flex max-[550px]:flex-col gap-3">
                            ...
                            <div className="border w-full px-4 py-3 mt-4 bg-white rounded-[10px]">
                                ...
                                <input type="text" {...register("name", { required: true })} placeholder="Enter Your Name" className="w-full outline-none mt-1" />
                            ...
                            <div className="border w-full px-4 py-3 bg-white mt-4 rounded-[10px]">
                                <label className="block text-sm font-medium text-black">Photo URL</label>
                                <input type="url" {...register("photoUrl", { required: true })} placeholder="Enter Photo URL" className="w-full outline-none mt-1" />
                        ...
                        <div className="border w-full px-4 py-3 bg-white mt-4 rounded-[10px]">
                            ...
                            {errors.role && <span className="text-red-600 text-sm">Role is required</span>}
                        </div>
                        ...
                        {/* Submit Button */}
                        <input type="submit" value="Sign Up" className="w-full py-3 bg-[#704FE6] rounded-[10px] text-white cursor-pointer hover:bg-gray-800 transition mt-6" />
                    </form>
                    ...
                    Have an account? <Link href={'/login'} className="text-blue-500 hover:underline">Sign In</Link>
                    </h1>
                </div>
            </div>
        </div>
