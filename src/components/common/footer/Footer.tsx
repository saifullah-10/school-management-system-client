...
const Footer: React.FC = () => {
  ...
  if (navigation?.includes("dashboard")) {
    return (
      <>
          ...
          <div className="flex flex-wrap -mx-4">
            ...
            <div className="w-full lg:w-1/4 px-4 mb-8">
              ...
              <p className="text-sm text-gray-400 mb-4">
                ...
                student success. With modern facilities and a renowned faculty,
                it provides a dynamic environment for learning, research, and
