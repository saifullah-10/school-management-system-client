  ...
  return (
    <div
      className={`border-b-[1px] border-[#704FE6] sticky top-0 z-50 bg-white  ${
        navigate === "/login" || navigate === "/register" ? "hidden" : ""
      }`}
    >
      ...
      <div
        ref={menuRef}
        className={`flex flex-col nav-link absolute bg-white text-center space-y-4 w-full  border-y-2  p-5 min-[850px]:hidden ${
          menu ? "" : "hidden"
        }`}
      >
        {Links}
